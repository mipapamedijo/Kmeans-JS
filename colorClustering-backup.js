...
function setup(){
  ...
  // dropArea = select('#imageLoader');
  // dropArea.style('padding','5%');
  // dropArea.drop(loadFile);
...
function getFrame(){
  ...
  video.hide();
  var vid_cnvs = document.getElementById('video_canvas');
  ...
  // var l;
  var div_data = document.getElementById("results");
